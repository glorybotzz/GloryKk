...
global.namebot = 'Glory BOT' //Nama bot mu
global.nameown = 'Glory ⃟📄' //Nama mu
...
global.author = '                © Glory BOT By Glory' //Wm author
global.botintro = 'Hallo, Kenalin saya Glory BOT Saya akan membantu Anda kapan pun & Dimana pun, Saya asisten bot WhatsApp yang di buat oleh *GloryXD* Saya di rilis pada tanggal\n🗓 ️_16/04/2022_'
...
global.owner = [
  ...
  ['79680341674'], //Owner2
  ['6283834994212', 'Glory ! 🥶', true] //Ini buat kamu!
...
/*⫘⫘⫘⫘ WATERMAK ⫘⫘⫘⫘⫘*/
//GANTI JANGAN NGASAL.
global.wm = '                「 Glory - BOT ⁩இ 」' //Wm
global.wm2 = '➳༻❀Glory - 📄⃟❁ུ۪۪.;:୭̥.' //Name Wm
global.wm3 = '赤 Glory - BOT'
global.hiasan = '꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦'
global.botdate = `🗓️️ 𝗗𝗮𝘁𝗲: ${week} ${date}`
global.bottime = `𝗪𝗔𝗞𝗧𝗨 : ${wib}`
global.titlebot = '𝗬𝗧: Road To Glory' //Ganti serah lu
...
/*⫘⫘⫘⫘ STICKER ⫘⫘⫘⫘⫘*/
global.stickpack = 'YT: RoadToGlory'
global.stickauth = `© Road To\nGloryWhatsapp\nNomor: ${global.nomorbot}`
global.packname = 'By Glory'
